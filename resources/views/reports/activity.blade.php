...
<div class="page-header">
    ...
    <div class="d-flex gap-1">
        <a href="{{ route('reports.activity', request()->all() + ['export' => 'csv']) }}" class="btn btn-secondary">
    ...
    <div class="card-header">
        <div class="card-header-row">
            <span>
                ...
                &nbsp;Archiving Activity
                <span class="results-count">&nbsp;— <strong>{{ $charts->total() }}</strong> archives found</span>
            </span>
        </div>
    </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="font-weight:500">{{ $chart->archivedBy->name }}</td>
                        <td>
